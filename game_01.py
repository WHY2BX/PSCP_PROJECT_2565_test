...
show_status = Label(window, textvariable=status_str, font=('Angsana New', 20))
...
show_category = Label(window, textvariable=category_str, font=('Angsana New', 20)) 
show_category.pack(pady=10)

clue_str = StringVar()
clue_str.set(' | '.join(clue))
show_clue = Label(window, textvariable=clue_str, font=('Cordia New', 50))
...
show_hint_text = Label(window, textvariable=hints_text, font=('Angsana New', 20))
show_hint_text.pack()
show_hint_text = Label(window, textvariable=hints_str, font=('Angsana New', 28))
show_hint_text.pack(pady=10)

#กล่องให้กรอก guess
textentry = Entry(window, width=10, borderwidth=1, font=('Angsana New', 28), justify='center')
